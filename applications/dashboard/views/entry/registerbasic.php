...
<div class="FormTitleWrapper">
    ...
    <div class="FormWrapper">
        ...
        <ul>
            <li>
                    <label for="Form_Email2">Nama Anda</label>
<div class="TextBoxWrapper"><input type="text" id="Form_Email2" name="Nama" value="" class="InputBox" /></div>                </li>
            <li>
            ...
            <li>
                ...
                echo wrap(sprintf(t('Password anda minimal berisi panjang %d karakter.'), c('Garden.Registration.MinPasswordLength')), 'div', array('class' => 'Gloss'));
